...
public class XrActivity extends XServerDisplayActivity implements TextWatcher {
    ...
    /**
     * Compatibility helper used by the Ludashi-aligned renderer.
     * XR is considered enabled only when an {@link XrActivity} is actually running.
     */
    public static boolean isEnabled(Context context) {
        return isSupported() && instance != null;
    }
