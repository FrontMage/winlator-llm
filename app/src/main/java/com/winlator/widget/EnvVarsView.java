...
public class EnvVarsView extends FrameLayout {
    public static final String[][] knownEnvVars = {
        ...
        // FEX core knobs (mirrors third_party/Winlator-Ludashi fexcore_env_vars.json)
        {"FEX_TSOENABLED", "CHECKBOX", "0", "1"},
        {"FEX_VECTORTSOENABLED", "CHECKBOX", "0", "1"},
        {"FEX_HALFBARRIERTSOENABLED", "CHECKBOX", "0", "1"},
        {"FEX_MEMCPYSETTSOENABLED", "CHECKBOX", "0", "1"},
        {"FEX_X87REDUCEDPRECISION", "CHECKBOX", "0", "1"},
        {"FEX_MULTIBLOCK", "CHECKBOX", "0", "1"},
        {"FEX_MAXINST", "NUMBER"},
        {"FEX_HOSTFEATURES", "SELECT", "enablesve", "disablesve", "enableavx", "disableavx", "off"},
        {"FEX_SMALLTSCSCALE", "CHECKBOX", "0", "1"},
        {"FEX_SMC_CHECKS", "SELECT", "none", "mtrack", "full"},
        {"FEX_VOLATILEMETADATA", "CHECKBOX", "0", "1"},
        {"FEX_MONOHACKS", "CHECKBOX", "0", "1"},
        {"FEX_HIDEHYPERVISORBIT", "CHECKBOX", "0", "1"},
        {"FEX_DISABLEL2CACHE", "CHECKBOX", "0", "1"},
        {"FEX_DYNAMICL1CACHE", "CHECKBOX", "0", "1"},
        // FEX debug/diagnostics (Winlator-specific)
        {"FEX_SILENTLOG", "CHECKBOX", "0", "1"},
        {"FEX_DIAG_SIGILL", "CHECKBOX", "0", "1"},
        {"FEX_DIAG_SMC", "CHECKBOX", "0", "1"},
        // WoW/Warden heuristics
        {"FEX_BNET_FORCE_X86", "CHECKBOX", "0", "1"},
        {"FEX_BNET_DETECT_LOG", "CHECKBOX", "0", "1"},
        {"FEX_BNET_ID_NTQUERYSYSTEMINFORMATION", "TEXT"},
        {"FEX_BNET_ID_NTQUERYINFORMATIONPROCESS", "TEXT"},
        {"FEX_BNET_ID_NTQUERYINFORMATIONTHREAD", "TEXT"}
    };
    ...
    public void add(String name, String value) {
        ...
        // If the user adds a variable with a boolean-like "0/1" value, render it as a toggle by default.
        // This is especially useful for many FEX knobs.
        final boolean inferCheckbox01 = knownEnvVar == null && ("0".equals(value) || "1".equals(value));
        if (inferCheckbox01) type = "CHECKBOX";
        ...
        switch (type) {
            case "CHECKBOX":
                ...
                final String offValue = (knownEnvVar != null && knownEnvVar.length > 2) ? knownEnvVar[2] : "0";
                final String onValue = (knownEnvVar != null && knownEnvVar.length > 3) ? knownEnvVar[3] : "1";
                getValueCallback = () -> toggleButton.isChecked() ? onValue : offValue;
                break;
            case "SELECT":
