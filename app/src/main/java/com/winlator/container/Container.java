...
public class Container {
    // Vanilla-aligned defaults: keep envVars minimal and let graphicsDriverConfig drive wrapper/adrenotools.
    ...
    public static final String DEFAULT_WINCOMPONENTS = "direct3d=1,directsound=0,directmusic=0,directshow=0,directplay=0,vcrun2010=1,wmdecoder=1,rsaenh=0,cryptbase=0";
    ...
    // For our current package id (com.winlator.llm), use an app-private writable storage root.
    // External downloads remain on D: (requires storage permission on newer Android versions).
    public static final String DEFAULT_DRIVES = "D:"+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)+"E:/data/data/com.winlator.llm/storage";
    ...
    // Mirror vanilla's default wrapper driver config as a baseline for new containers.
    public static final String DEFAULT_GRAPHICS_DRIVER_CONFIG =
            "gpuName=Device;" +
            "maxDeviceMemory=0;" +
    ...
    private String graphicsDriverConfig = DEFAULT_GRAPHICS_DRIVER_CONFIG;
    private String dxwrapper = DEFAULT_DXWRAPPER;
    private String dxwrapperConfig = "";
    private String wincomponents = DEFAULT_WINCOMPONENTS;
    private String audioDriver = DEFAULT_AUDIO_DRIVER;
    private String drives = DEFAULT_DRIVES;
    private String wineVersion = "proton-"+com.winlator.core.DefaultVersion.ARM64EC_PROTON+"-arm64ec";
    ...
    public void loadData(JSONObject data) throws JSONException {
        wineVersion = "proton-" + com.winlator.core.DefaultVersion.ARM64EC_PROTON + "-arm64ec";
        dxwrapperConfig = "";
    ...
    public static void checkObsoleteOrMissingProperties(JSONObject data) {
        try {
            ...
            if (data.has("graphicsDriver")) {
                ...
                // Vanilla baseline uses the Vulkan wrapper + Adrenotools stack.
                if (graphicsDriver.equals("turnip") || graphicsDriver.equals("turnip-zink")) {
