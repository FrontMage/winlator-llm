...
public class WineInfo implements Parcelable {
    ...
    public final String kind; // "wine" or "proton" for installed runtimes
    ...
    public WineInfo(String kind, String version, String subversion, String arch, String path) {
        this.kind = kind != null && !kind.isEmpty() ? kind : "wine";
        this.version = version;
    ...
    public String identifier() {
        if (this == MAIN_WINE_VERSION) return "wine-" + fullVersion() + "-custom";
        return kind + "-" + fullVersion() + "-" + arch;
    }
